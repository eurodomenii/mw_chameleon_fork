...
4. Open the `composer.local.json` file in an editor and add the Chameleon1 skin
...
5. To actually install Chameleon1 run the command
   ```bash
   COMPOSER=composer.local.json composer require --no-update mediawiki/chameleon1-skin:~3.0
