<?php
/**
 * File holding the Chameleon1Template class
 *
...
/**
 * BaseTemplate class for the Chameleon1 skin
 *
 * @author Stephan Gambke
 * @since 1.0
 * @ingroup Skins
 */
class Chameleon1Template extends BaseTemplate {
	 ...
	 *
	 * @throws \MWException
	 * @return \Skins\Chameleon1\Components\Container
	 */
