...
use Skins\Chameleon1\Tests\Util\DocumentElementFinder;
use Skins\Chameleon1\Tests\Util\MockupFactory;
use Skins\Chameleon1\Tests\Util\XmlFileProvider;
...
class GenericComponentTestCase extends TestCase {
	...
	public function getTestObject( \DOMElement $domElement = null ) {
		if ( $this->testObject === null ) {
			...
			$this->testObject = new $this->classUnderTest( $chameleon1Template, $domElement );
		}
	...
	/**
	 * @return \Skins\Chameleon1\Chameleon1Template
	 * @throws \MWException
	 */
	public function getChameleon1SkinTemplateStub() {
		return MockupFactory::makeFactory( $this )->getChameleon1SkinTemplateStub();
	}
	...
	public function getNameOfComponentUnderTest() {
		return str_replace( 'Skins\\Chameleon1\\Components\\', '', get_class( $this->getTestObject() ) );
	}
