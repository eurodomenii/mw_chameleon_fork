...
/**
 * @coversDefaultClass \Skins\Chameleon1\Components\NavMenu
 * @covers ::<private>
 * @covers ::<protected>
 *
...
class NavMenuTest extends GenericComponentTestCase {
	...
	protected $classUnderTest = '\Skins\Chameleon1\Components\NavMenu';
	...
	public function testGetHTML_HasValidId( $domElement ) {
		...
		$chameleon1Template = $this->getMockBuilder( Chameleon1Template::class )
