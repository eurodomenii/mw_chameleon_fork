...
use Skins\Chameleon1\Components\NavbarHorizontal;

/**
 * @coversDefaultClass \Skins\Chameleon1\Components\NavbarHorizontal
 * @covers ::<private>
 * @covers ::<protected>
 *
...
class NavbarHorizontalTest extends GenericComponentTestCase {
	...
	protected $classUnderTest = '\Skins\Chameleon1\Components\NavbarHorizontal';
	...
	public function testGetHtml_containsNavElement() {
		...
		$chameleon1Template->expects( $this->any() )
			->method( 'getMsg' )
