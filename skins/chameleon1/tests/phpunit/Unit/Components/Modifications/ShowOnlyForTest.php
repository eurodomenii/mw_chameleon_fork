...
/**
 * @coversDefaultClass \Skins\Chameleon1\Components\Modifications\ShowOnlyFor
 * @covers ::<private>
 * @covers ::<protected>
 *
...
class ShowOnlyForTest extends GenericModificationTestCase {
	...
	protected $classUnderTest = '\Skins\Chameleon1\Components\Modifications\ShowOnlyFor';
