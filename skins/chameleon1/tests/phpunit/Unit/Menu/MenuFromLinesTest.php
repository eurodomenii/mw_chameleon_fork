...
namespace Skins\Chameleon1\Tests\Unit\Menu;

use Skins\Chameleon1\Menu\MenuFromLines;

/**
 * Class MenuFromLinesTest
 *
 * @coversDefaultClass \Skins\Chameleon1\Menu\MenuFromLines
 * @covers ::<private>
 * @covers ::<protected>
 *
...
class MenuFromLinesTest extends \PHPUnit\Framework\TestCase {
	...
	public function testCanConstruct() {
		...
		$this->assertInstanceOf(
			'Skins\Chameleon1\Menu\MenuFromLines',
			$instance
		);
	}
