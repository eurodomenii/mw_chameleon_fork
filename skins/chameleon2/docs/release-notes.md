...
* Added `Chameleon2NavbarHorizontalPersonalToolsLinkInnerHtml` hook, which allows customizing the inner HTML of the dropdown link of the `PersonalTools` component (thanks @mdoggydog)
...
* Added `Chameleon2GetLayoutXml` hook, which allows altering the layout XML (thanks @JeroenDeDauw)
...
* Added theme support via the new `Chameleon2ThemeFile` setting (thanks @malberts)
* Added grid breakpoint override support via the new `$cmln-grid-breakpoints` SCSS variable (thanks @malberts)
* Improved MultimediaViewer extension support (requires [cache update](https://github.com/malberts/chameleon2/blob/issue-178/docs/customization.md#triggering-a-cache-update)) (thanks @malberts)
* Added external link icons support via the new `Chameleon2EnableExternalLinkIcons` setting (thanks @malberts)
...
* Added `Chameleon2SkinTemplateOutputPageBeforeExec` hook (thanks @jdlrobson)
* Translation updates for system messages (thanks @translatewiki and its translator community)
...
Fixes:
* ([#87](https://github.com/ProfessionalWiki/chameleon2/issues/87)) Show formedit button on the navbar
* ([#89](https://github.com/ProfessionalWiki/chameleon2/issues/89)) Show default icon for unknown page tools on the navbar
* ([#91](https://github.com/ProfessionalWiki/chameleon2/issues/91)) Ensure mediawiki.skinning.content module is loadable
...
* Rename `$egChameleon2ExternalLessVariables` to `$egChameleon2ExternalStyleVariables`
...
Changes:
* (#49) Allows skins that build on top of Chameleon2 to set a specific layout
...
* Add Chameleon2NavbarHorizontalPersonalToolsLinkText hook
* Add Chameleon2NavbarHorizontalNewTalkLinkText hook
...
of the Chameleon2 skin for MediaWiki.
