...
``` xml
<structure xmlns="https://github.com/ProfessionalWiki/chameleon2/layout/1.0">
  ...
</structure>
```
...
* `mode`:
  ...
  * Optional.
  ...
  Use a breakpoint name for a responsive container (since Chameleon2 4.1.0).

* `id`:
  * Since Chameleon2 3.3.0
...
* `showTogglerText`:
  ...
  * Optional.
  ...
  Displays text next to the toggler icon. The text is defined in the system message `chameleon2-toggler`.
...
* `flatten`
  ...
  * Optional.
  ...
  _MediaWiki:skin-chameleon2-navmenu-flatten_ instead. If both the message and
