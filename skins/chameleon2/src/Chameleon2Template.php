<?php
/**
 * File holding the Chameleon2Template class
 *
...
/**
 * BaseTemplate class for the Chameleon2 skin
 *
 * @author Stephan Gambke
 * @since 1.0
 * @ingroup Skins
 */
class Chameleon2Template extends BaseTemplate {
	 ...
	 *
	 * @throws \MWException
	 * @return \Skins\Chameleon2\Components\Container
	 */
