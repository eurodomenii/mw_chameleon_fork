...
class ResourceLoaderRegisterModules {
	...
	public function process(): void {
		...
		$this->registerChameleon2();
	}

	private function registerBootstrap(): void {
		$this->resourceLoader->register(
			'zzz.ext.bootstrap2.styles',
			$this->configuration['wgResourceModules']['ext.bootstrap2.styles']
		);
	}

	private function registerChameleon2(): void {
		$this->resourceLoader->register( 'skins.chameleon2', [
