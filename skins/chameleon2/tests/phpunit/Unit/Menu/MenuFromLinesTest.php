...
namespace Skins\Chameleon2\Tests\Unit\Menu;

use Skins\Chameleon2\Menu\MenuFromLines;

/**
 * Class MenuFromLinesTest
 *
 * @coversDefaultClass \Skins\Chameleon2\Menu\MenuFromLines
 * @covers ::<private>
 * @covers ::<protected>
 *
...
class MenuFromLinesTest extends \PHPUnit\Framework\TestCase {
	...
	public function testCanConstruct() {
		...
		$this->assertInstanceOf(
			'Skins\Chameleon2\Menu\MenuFromLines',
			$instance
		);
	}
