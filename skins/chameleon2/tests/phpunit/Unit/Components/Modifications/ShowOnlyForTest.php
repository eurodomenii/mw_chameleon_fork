...
/**
 * @coversDefaultClass \Skins\Chameleon2\Components\Modifications\ShowOnlyFor
 * @covers ::<private>
 * @covers ::<protected>
 *
...
class ShowOnlyForTest extends GenericModificationTestCase {
	...
	protected $classUnderTest = '\Skins\Chameleon2\Components\Modifications\ShowOnlyFor';
