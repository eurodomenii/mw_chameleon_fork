...
use Skins\Chameleon2\Tests\Util\DocumentElementFinder;
use Skins\Chameleon2\Tests\Util\MockupFactory;
use Skins\Chameleon2\Tests\Util\XmlFileProvider;
...
class GenericComponentTestCase extends TestCase {
	...
	public function getTestObject( \DOMElement $domElement = null ) {
		if ( $this->testObject === null ) {
			...
			$this->testObject = new $this->classUnderTest( $chameleon2Template, $domElement );
		}
	...
	/**
	 * @return \Skins\Chameleon2\Chameleon2Template
	 * @throws \MWException
	 */
	public function getChameleon2SkinTemplateStub() {
		return MockupFactory::makeFactory( $this )->getChameleon2SkinTemplateStub();
	}
	...
	public function getNameOfComponentUnderTest() {
		return str_replace( 'Skins\\Chameleon2\\Components\\', '', get_class( $this->getTestObject() ) );
	}
