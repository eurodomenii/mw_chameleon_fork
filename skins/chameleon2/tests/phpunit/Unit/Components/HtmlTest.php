...
use Skins\Chameleon2\Components\Html;

/**
 * @coversDefaultClass \Skins\Chameleon2\Components\Html
 * @covers ::<private>
 * @covers ::<protected>
 *
...
class HtmlTest extends GenericComponentTestCase {
	...
	protected $classUnderTest = '\Skins\Chameleon2\Components\Html';
	...
	public function testGetHtml_OnSyntheticLayoutXml( \DOMElement $domElement ) {
		...
		$instance = new Html( $chameleon2Template, $domElement );
