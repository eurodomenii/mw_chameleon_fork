<?php
/**
 * File holding the BootstrapManager1 class
 *
...
class BootstrapManager1 {
	...
	protected function adjustArrayElementOfResourceModuleDescription( $key, $value,
		$filetype = 'styles' ) {
		if ( !isset( $GLOBALS[ 'wgResourceModules' ][ 'ext.bootstrap1.' . $filetype ][ $key ] ) ) {
			$GLOBALS[ 'wgResourceModules' ][ 'ext.bootstrap1.' . $filetype ][ $key ] = [];
		}
