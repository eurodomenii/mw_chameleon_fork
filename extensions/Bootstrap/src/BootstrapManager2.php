<?php
/**
 * File holding the BootstrapManager2 class
 *
...
class BootstrapManager2 {
	...
	protected function adjustArrayElementOfResourceModuleDescription( $key, $value,
		$filetype = 'styles' ) {
		if ( !isset( $GLOBALS[ 'wgResourceModules' ][ 'ext.bootstrap2.' . $filetype ][ $key ] ) ) {
			$GLOBALS[ 'wgResourceModules' ][ 'ext.bootstrap2.' . $filetype ][ $key ] = [];
		}
